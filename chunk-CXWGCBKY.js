...
function SgTemplateRequestApproval_ng_template_2_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "hrm-input", 37);
    \u0275\u0275twoWayListener("ngModelChange", function SgTemplateRequestApproval_ng_template_2_Conditional_8_Template_hrm_input_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r4);
...
function SgTemplateRequestApproval_ng_template_2_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 38);
    \u0275\u0275listener("click", function SgTemplateRequestApproval_ng_template_2_Conditional_9_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function SgTemplateRequestApproval_ng_template_2_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
...
function SgTemplateRequestApproval_ng_template_2_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "hrm-button", 40);
    \u0275\u0275listener("click", function SgTemplateRequestApproval_ng_template_2_Conditional_12_Template_hrm_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(2, " Duy\u1EC7t");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "hrm-button", 41);
    \u0275\u0275listener("click", function SgTemplateRequestApproval_ng_template_2_Conditional_12_Template_hrm_button_click_3_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function SgTemplateRequestApproval_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("pageIndexChange", function SgTemplateRequestApproval_ng_template_2_Template_hrm_list_page_pageIndexChange_2_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function SgTemplateRequestApproval_ng_template_2_Template_hrm_segmented_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 30)(6, "hrm-segmented", 29);
    \u0275\u0275twoWayListener("ngModelChange", function SgTemplateRequestApproval_ng_template_2_Template_hrm_segmented_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275conditionalCreate(8, SgTemplateRequestApproval_ng_template_2_Conditional_8_Template, 1, 1, "hrm-input", 32)(9, SgTemplateRequestApproval_ng_template_2_Conditional_9_Template, 7, 3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 33);
    \u0275\u0275conditionalCreate(11, SgTemplateRequestApproval_ng_template_2_Conditional_11_Template, 3, 2, "hrm-button", 20)(12, SgTemplateRequestApproval_ng_template_2_Conditional_12_Template, 6, 5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "hrm-data-view", 34);
    \u0275\u0275listener("selectedKeysChange", function SgTemplateRequestApproval_ng_template_2_Template_hrm_data_view_selectedKeysChange_13_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.selKeys.set($event));
    })("modeChange", function SgTemplateRequestApproval_ng_template_2_Template_hrm_data_view_modeChange_13_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.mode.set($event));
    })("openRecord", function SgTemplateRequestApproval_ng_template_2_Template_hrm_data_view_openRecord_13_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.openDetail($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "hrm-detail-peek", 35);
    \u0275\u0275twoWayListener("openChange", function SgTemplateRequestApproval_ng_template_2_Template_hrm_detail_peek_openChange_14_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.peekOpen, $event) || (ctx_r1.peekOpen = $event);
      return \u0275\u0275resetView($event);
    })("peekModeChange", function SgTemplateRequestApproval_ng_template_2_Template_hrm_detail_peek_peekModeChange_14_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.selKeys().length === 0 ? 8 : 9);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.selKeys().length === 0 ? 11 : 12);
    \u0275\u0275advance(2);
    \u0275\u0275property("columns", ctx_r1.cols())("data", ctx_r1.filteredRows())("selectable", true)("selectedKeys", ctx_r1.selKeys())("modes", \u0275\u0275pureFunction0(32, _c9))("mode", ctx_r1.mode())("boardGroups", ctx_r1.boardGroups)("boardCardTemplate", dvCard_r8)("ganttLabelTemplate", gtLabel_r9)("ganttBarTone", ctx_r1.ganttTone)("cardTemplate", dvCard_r8);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("open", ctx_r1.peekOpen)("peekMode", ctx_r1.peekMode);
    \u0275\u0275property("modes", \u0275\u0275pureFunction0(33, _c10))("expandable", false)("title", ((tmp_40_0 = ctx_r1.selectedRow()) == null ? null : tmp_40_0.code) ?? "")("content", ctx_r1.reqDetailTpl() ?? null)("footer", peekFooter_r7)("modeLabels", ctx_r1.peekLabels)("routeUrl", ctx_r1.peekRoute());
    \u0275\u0275advance(2);
...
function SgTemplateRequestApproval_ng_template_4_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "sg-request-detail", 42);
  }
  if (rf & 2) {
    \u0275\u0275property("req", ctx);
  }
...
function SgTemplateRequestApproval_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SgTemplateRequestApproval_ng_template_4_Conditional_0_Template, 1, 1, "sg-request-detail", 42);
  }
  if (rf & 2) {
    let tmp_14_0;
    const ctx_r1 = \u0275\u0275nextContext();
...
function SgTemplateRequestApproval_ng_template_6_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "hrm-action-bar", 44);
...
function SgTemplateRequestApproval_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SgTemplateRequestApproval_ng_template_6_Conditional_0_Template, 1, 1, "hrm-action-bar", 43);
  }
  if (rf & 2) {
    let tmp_14_0;
    const ctx_r1 = \u0275\u0275nextContext();
...
function SgTemplateRequestApproval_ng_template_22_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "span", 50)(1, "button", 52);
...
function SgTemplateRequestApproval_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SgTemplateRequestApproval_ng_template_22_Conditional_0_Template, 5, 4, "span", 50)(1, SgTemplateRequestApproval_ng_template_22_Conditional_1_Template, 2, 2, "button", 51);
  }
  if (rf & 2) {
...
function SgTemplateRequestApproval_ng_template_24_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 59)(1, "hrm-button", 60);
    ...
    \u0275\u0275text(3, " Duy\u1EC7t");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "hrm-button", 61);
...
function SgTemplateRequestApproval_ng_template_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "hrm-user-cell", 45)(3, "hrm-status", 49);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 57)(5, "span", 46);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "hrm-tag", 47);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(13, SgTemplateRequestApproval_ng_template_24_Conditional_13_Template, 7, 5, "div", 59);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;a84fa9a5df99fefc2f1c2a4ed58f9fc3ded20a3da6c749eaf0a4dff861863cdc;/Users/mac/projects/Final Core Prototype/vnr.hrm.prototype/src/vnr.hrm.web/apps/ds-demo/src/app/features/styleguide/pages/hrm/template/request-approval-page.ts */\n.lp-desktop {\n  height: 760px;\n  border: 1px solid var(--border-sub);\n  border-radius: var(--radius-xl);\n  overflow: hidden;\n  box-shadow: var(--shadow-regular-sm);\n}\n.lp-desktop--full {\n  height: 100vh;\n  border: 0;\n  border-radius: 0;\n  box-shadow: none;\n}\n.lp-full {\n  margin-top: 14px;\n}\n.lp-full-link {\n  text-decoration: none;\n}\n.lp-desktop ::ng-deep .shell-content {\n  padding: 0;\n  display: flex;\n  flex-direction: column;\n  min-height: 0;\n}\n.lp-desktop ::ng-deep .shell-content hrm-list-page {\n  flex: 1 1 auto;\n  min-height: 0;\n}\n.lp-desktop ::ng-deep hrm-data-view .dv-bar {\n  display: none;\n}\n.lp-desktop ::ng-deep .ant-table-tbody > tr > td,\n.lp-desktop ::ng-deep .ant-table-thead > tr > th {\n  white-space: nowrap;\n}\n:host ::ng-deep .ant-tag {\n  margin: 0;\n}\n.lp-hdr {\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  gap: var(--space-2);\n}\n.lp-tabsrow {\n  display: flex;\n}\n.tbx {\n  display: flex;\n  align-items: center;\n  gap: var(--space-2);\n  min-width: 0;\n}\n.bx-clear {\n  display: grid;\n  place-items: center;\n  width: 28px;\n  height: 28px;\n  border: 0;\n  background: transparent;\n  border-radius: var(--radius-md);\n  cursor: pointer;\n  color: var(--text-sub);\n}\n.bx-clear:hover {\n  background: var(--bg-surface-subtle);\n  color: var(--text-strong);\n}\n.bx-count {\n  font-size: var(--fs-13);\n  color: var(--text-body);\n  background: var(--primary-bg-subtle);\n  padding: 4px 10px;\n  border-radius: var(--radius-full);\n  white-space: nowrap;\n}\n.bx-count b {\n  color: var(--primary-base);\n}\n.aq {\n  display: inline-flex;\n  gap: var(--space-2, 8px);\n}\n.aq-btn {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  width: 34px;\n  height: 34px;\n  border: 1px solid var(--border-sub);\n  background: var(--bg-surface);\n  border-radius: var(--radius-md);\n  cursor: pointer;\n  color: var(--text-sub);\n  transition:\n    filter .12s,\n    background-color .12s,\n    border-color .12s,\n    color .12s;\n}\n.aq-ok {\n  background: var(--primary-base);\n  border-color: var(--primary-base);\n  color: var(--static-white, #fff);\n}\n.aq-no {\n  background: var(--error-base);\n  border-color: var(--error-base);\n  color: var(--static-white, #fff);\n}\n.aq-ok:hover,\n.aq-no:hover {\n  filter: brightness(0.95);\n}\n.aq-view:hover {\n  border-color: var(--primary-base);\n  color: var(--primary-base);\n}\n.c-code {\n  font-family: var(--font-mono, ui-monospace, monospace);\n  font-size: var(--fs-13);\n  color: var(--text-strong);\n  font-weight: var(--font-medium, 500);\n}\n.c-mut {\n  font-size: var(--fs-13);\n  color: var(--text-sub);\n}\n.rc {\n  display: flex;\n  flex-direction: column;\n  gap: var(--space-2, 8px);\n}\n.rc-top {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: var(--space-2);\n}\n.rc-line {\n  display: flex;\n  align-items: center;\n  gap: var(--space-2, 8px);\n}\n.rc-row {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  min-width: 0;\n  font-size: var(--fs-12);\n  color: var(--text-sub);\n}\n.rc-row tabler-icon {\n  flex: none;\n  color: var(--text-soft);\n}\n.rc-foot {\n  display: flex;\n  gap: var(--space-2, 8px);\n  padding-top: var(--space-2, 8px);\n  border-top: 1px solid var(--border-soft);\n}\n/*# sourceMappingURL=request-approval-page.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SgTemplateRequestApproval, { className: "SgTemplateRequestApproval", filePath: "apps/ds-demo/src/app/features/styleguide/pages/hrm/template/request-approval-page.ts", lineNumber: 213 });
})();
export {
  SgTemplateRequestApproval
};
//# sourceMappingURL=chunk-CXWGCBKY.js.map
