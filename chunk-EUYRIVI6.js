...
function SgTemplateContractMgmt_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "hrm-app-shell", 20);
    \u0275\u0275element(1, "sg-template-side-nav", 21);
    \u0275\u0275elementStart(2, "hrm-list-page", 22);
    \u0275\u0275twoWayListener("pageIndexChange", function SgTemplateContractMgmt_ng_template_3_Template_hrm_list_page_pageIndexChange_2_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.page, $event) || (ctx_r1.page = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(3, "div", 23)(4, "hrm-button", 24);
    \u0275\u0275listener("click", function SgTemplateContractMgmt_ng_template_3_Template_hrm_button_click_4_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.openCreate());
    });
    \u0275\u0275element(5, "tabler-icon", 16);
    \u0275\u0275text(6, " Th\xEAm h\u1EE3p \u0111\u1ED3ng");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 25)(8, "hrm-tabs", 26);
    \u0275\u0275twoWayListener("selectedIndexChange", function SgTemplateContractMgmt_ng_template_3_Template_hrm_tabs_selectedIndexChange_8_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.tabIdxModel, $event) || (ctx_r1.tabIdxModel = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275element(9, "hrm-tab", 27)(10, "hrm-tab", 27)(11, "hrm-tab", 27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 28)(13, "hrm-input", 29);
    \u0275\u0275twoWayListener("ngModelChange", function SgTemplateContractMgmt_ng_template_3_Template_hrm_input_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 30)(15, "hrm-button", 15);
    \u0275\u0275element(16, "tabler-icon", 16);
    \u0275\u0275text(17, " Xu\u1EA5t");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "hrm-data-view", 31);
    \u0275\u0275listener("openRecord", function SgTemplateContractMgmt_ng_template_3_Template_hrm_data_view_openRecord_18_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.openEdit($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "hrm-detail-peek", 32);
    \u0275\u0275twoWayListener("openChange", function SgTemplateContractMgmt_ng_template_3_Template_hrm_detail_peek_openChange_19_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.peekOpenModel, $event) || (ctx_r1.peekOpenModel = $event);
      return \u0275\u0275resetView($event);
    })("peekModeChange", function SgTemplateContractMgmt_ng_template_3_Template_hrm_detail_peek_peekModeChange_19_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("columns", ctx_r1.cols())("data", ctx_r1.filteredRows())("modes", \u0275\u0275pureFunction0(27, _c7));
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("open", ctx_r1.peekOpenModel)("peekMode", ctx_r1.peekModeModel);
    \u0275\u0275property("modes", \u0275\u0275pureFunction0(28, _c8))("expandable", false)("title", ctx_r1.editingId() ? "S\u1EEDa h\u1EE3p \u0111\u1ED3ng" : "Th\xEAm h\u1EE3p \u0111\u1ED3ng")("content", ctx_r1.ctFormTpl() ?? null)("footer", ctx_r1.ctFooterTpl() ?? null)("modeLabels", ctx_r1.peekLabels)("routeUrl", ctx_r1.recordRoute);
    \u0275\u0275advance(2);
...
function SgTemplateContractMgmt_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SgTemplateContractMgmt_ng_template_7_Conditional_0_Template, 2, 2, "hrm-tag", 35)(1, SgTemplateContractMgmt_ng_template_7_Conditional_1_Template, 2, 0, "span", 36);
  }
  if (rf & 2) {
...
function SgTemplateContractMgmt_ng_template_9_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "\u2192");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, SgTemplateContractMgmt_ng_template_9_Conditional_1_Conditional_5_Template, 2, 3, "span", 40)(6, SgTemplateContractMgmt_ng_template_9_Conditional_1_Conditional_6_Template, 2, 0, "span", 38);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SgTemplateContractMgmt_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SgTemplateContractMgmt_ng_template_9_Conditional_0_Template, 2, 0, "span", 36)(1, SgTemplateContractMgmt_ng_template_9_Conditional_1_Template, 7, 2, "span", 37);
  }
  if (rf & 2) {
...
function SgTemplateContractMgmt_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "hrm-status-cell", 41);
  }
  if (rf & 2) {
...
function SgTemplateContractMgmt_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "hrm-action-cell", 42);
...
function SgTemplateContractMgmt_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 43)(1, "section", 44)(2, "div", 45);
    \u0275\u0275text(3, "Th\xF4ng tin nh\xE2n vi\xEAn");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 46)(5, "label", 47)(6, "span", 48);
    \u0275\u0275text(7, "M\xE3 nh\xE2n vi\xEAn");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "hrm-input", 49);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "label", 47)(10, "span", 48);
    \u0275\u0275text(11, "Ph\xF2ng ban");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "hrm-select", 50);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "label", 51)(14, "span", 48);
    \u0275\u0275text(15, "H\u1ECD v\xE0 t\xEAn ");
    \u0275\u0275elementStart(16, "b", 52);
    \u0275\u0275text(17, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "hrm-input", 53);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "label", 51)(20, "span", 48);
    \u0275\u0275text(21, "Ch\u1EE9c v\u1EE5");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "hrm-input", 54);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(23, "section", 44)(24, "div", 45);
    \u0275\u0275text(25, "Th\xF4ng tin h\u1EE3p \u0111\u1ED3ng");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "div", 46)(27, "label", 47)(28, "span", 48);
    \u0275\u0275text(29, "S\u1ED1 h\u1EE3p \u0111\u1ED3ng");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "hrm-input", 55);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "label", 47)(32, "span", 48);
    \u0275\u0275text(33, "Lo\u1EA1i h\u1EE3p \u0111\u1ED3ng");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "hrm-select", 56);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "label", 47)(36, "span", 48);
    \u0275\u0275text(37, "Ng\xE0y b\u1EAFt \u0111\u1EA7u");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "hrm-input", 57);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "label", 47)(40, "span", 48);
    \u0275\u0275text(41, "Ng\xE0y h\u1EBFt h\u1EA1n");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "hrm-input", 58);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(43, "label", 47)(44, "span", 48);
    \u0275\u0275text(45, "L\u01B0\u01A1ng c\u01A1 b\u1EA3n");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "hrm-input", 59);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "label", 47)(48, "span", 48);
    \u0275\u0275text(49, "T\xECnh tr\u1EA1ng");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "hrm-segmented", 60);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "label", 51)(52, "span", 48);
    \u0275\u0275text(53, "Ghi ch\xFA");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "hrm-textarea", 61);
...
function SgTemplateContractMgmt_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 62)(1, "hrm-button", 63);
    ...
    \u0275\u0275text(2, "Hu\u1EF7");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "hrm-button", 24);
  ...
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SgTemplateContractMgmt, [{
    ...
    <ng-template #screen>
      <hrm-app-shell contentPad="none">
        <sg-template-side-nav appSideNav selectedKey="contract" />
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SgTemplateContractMgmt, { className: "SgTemplateContractMgmt", filePath: "apps/ds-demo/src/app/features/styleguide/pages/hrm/template/contract-mgmt-page.ts", lineNumber: 248 });
})();

export {
  SgTemplateContractMgmt
};
//# sourceMappingURL=chunk-EUYRIVI6.js.map
