...
var HrmAlert = class _HrmAlert {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HrmAlert, selectors: [["hrm-alert"]], hostAttrs: [1, "hrm-alert"], inputs: { type: [1, "type"], message: [1, "message"], description: [1, "description"], showIcon: [1, "showIcon"], closeable: [1, "closeable"], banner: [1, "banner"], action: [1, "action"] }, decls: 1, vars: 7, consts: [[3, "nzType", "nzMessage", "nzDescription", "nzShowIcon", "nzCloseable", "nzAction", "nzBanner"]], template: function HrmAlert_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "nz-alert", 0);
      }
      if (rf & 2) {
        \u0275\u0275property("nzType", ctx.type())("nzMessage", ctx.message())("nzDescription", ctx.description() || null)("nzShowIcon", ctx.showIcon())("nzCloseable", ctx.closeable())("nzAction", ctx.action())("nzBanner", ctx.banner());
      }
    }, dependencies: [NzAlertModule, NzAlertComponent], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HrmAlert, [{
    ...
    <nz-alert
      ...
      [nzAction]="action()"
      [nzBanner]="banner()"></nz-alert>
  `,
      host: { class: "hrm-alert" }
    }]
  }], null, { type: [{ type: Input, args: [{ isSignal: true, alias: "type", required: false }] }], message: [{ type: Input, args: [{ isSignal: true, alias: "message", required: false }] }], description: [{ type: Input, args: [{ isSignal: true, alias: "description", required: false }] }], showIcon: [{ type: Input, args: [{ isSignal: true, alias: "showIcon", required: false }] }], closeable: [{ type: Input, args: [{ isSignal: true, alias: "closeable", required: false }] }], banner: [{ type: Input, args: [{ isSignal: true, alias: "banner", required: false }] }], action: [{ type: Input, args: [{ isSignal: true, alias: "action", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HrmAlert, { className: "HrmAlert", filePath: "libs/hrm-ui/src/lib/feedback/hrm-alert.ts", lineNumber: 22 });
})();

export {
  HrmAlert
};
//# sourceMappingURL=chunk-H656EMSP.js.map
