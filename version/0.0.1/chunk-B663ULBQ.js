...
var HrmAttendanceHeatmap = class _HrmAttendanceHeatmap {
  constructor() {
    ...
    this.option = computed(() => {
      ...
      const ramp = [tk("--seq-blue-1", "#dbecff"), tk("--seq-blue-3", "#2694fe"), tk("--seq-blue-5", "#02165e")];
      ...
      return {
        ...
        series: [{
          ...
          data: this.data(),
          label: { show: false },
          itemStyle: { borderColor: tk("--bg-surface", "#fff"), borderWidth: 2, borderRadius: 3 }
        }]
      };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HrmAttendanceHeatmap, { className: "HrmAttendanceHeatmap", filePath: "libs/hrm-ui/src/lib/chart/hrm-attendance-heatmap.ts", lineNumber: 14 });
})();
...
//# sourceMappingURL=chunk-B663ULBQ.js.map
