...
var NzCascaderComponent = (() => {
  ...
  return class NzCascaderComponent2 extends _classSuper {
    ...
    setupChangeListener() {
      this.input$.pipe(switchMap((input2) => fromEventOutsideAngular(input2?.nativeElement, "change")), takeUntilDestroyed(this.destroyRef)).subscribe((event) => event.stopPropagation());
    }
    setupFocusListener() {
      this.input$.pipe(switchMap((input2) => fromEventOutsideAngular(input2?.nativeElement, "focus")), takeUntilDestroyed(this.destroyRef)).subscribe(() => this.handleInputFocus());
      this.input$.pipe(switchMap((input2) => fromEventOutsideAngular(input2?.nativeElement, "blur")), takeUntilDestroyed(this.destroyRef)).subscribe(() => this.handleInputBlur());
    }
...
// libs/hrm-ui/src/lib/data-entry/hrm-cascader.ts
var toNz = (s) => s === "sm" ? "small" : s === "lg" ? "large" : "default";
var HrmCascader = class _HrmCascader extends HrmControl {
  constructor() {
    super(...arguments);
  ...
  static {
    this.\u0275fac = /* @__PURE__ */ (() => {
      let \u0275HrmCascader_BaseFactory;
      return function HrmCascader_Factory(__ngFactoryType__) {
        return (\u0275HrmCascader_BaseFactory || (\u0275HrmCascader_BaseFactory = \u0275\u0275getInheritedFactory(_HrmCascader)))(__ngFactoryType__ || _HrmCascader);
      };
    })();
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HrmCascader, selectors: [["hrm-cascader"]], hostAttrs: [1, "hrm-cascader"], hostVars: 2, hostBindings: function HrmCascader_HostBindings(rf, ctx) {
      if (rf & 2) {
        \u0275\u0275classProp("hrm-status-success", ctx.status() === "success");
      }
    }, inputs: { options: [1, "options"], placeholder: [1, "placeholder"], allowClear: [1, "allowClear"], showSearch: [1, "showSearch"], size: [1, "size"], status: [1, "status"] }, features: [\u0275\u0275ProvidersFeature([{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => _HrmCascader), multi: true }]), \u0275\u0275InheritDefinitionFeature], decls: 1, vars: 8, consts: [[2, "width", "100%", 3, "ngModelChange", "nzClear", "ngModel", "nzOptions", "nzPlaceHolder", "nzAllowClear", "nzShowSearch", "nzDisabled", "nzSize", "nzStatus"]], template: function HrmCascader_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "nz-cascader", 0);
        \u0275\u0275listener("ngModelChange", function HrmCascader_Template_nz_cascader_ngModelChange_0_listener($event) {
          return ctx.emit($event);
        })("nzClear", function HrmCascader_Template_nz_cascader_nzClear_0_listener() {
          return ctx.markTouched();
        });
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275property("ngModel", ctx.value())("nzOptions", ctx.options())("nzPlaceHolder", ctx.placeholder())("nzAllowClear", ctx.allowClear())("nzShowSearch", ctx.showSearch())("nzDisabled", ctx.disabled())("nzSize", ctx.toNz(ctx.size()))("nzStatus", ctx.toNzStatus(ctx.status()));
      }
    }, dependencies: [FormsModule, NgControlStatus, NgModel, NzCascaderModule, NzCascaderComponent], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HrmCascader, [{
    type: Component,
    args: [{
      selector: "hrm-cascader",
    ...
    <nz-cascader
      ...
      [nzDisabled]="disabled()"
      [nzSize]="toNz(size())"
      [nzStatus]="toNzStatus(status())"></nz-cascader>
  `,
      host: { class: "hrm-cascader", "[class.hrm-status-success]": "status() === 'success'" },
      providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => HrmCascader), multi: true }]
    }]
  }], null, { options: [{ type: Input, args: [{ isSignal: true, alias: "options", required: false }] }], placeholder: [{ type: Input, args: [{ isSignal: true, alias: "placeholder", required: false }] }], allowClear: [{ type: Input, args: [{ isSignal: true, alias: "allowClear", required: false }] }], showSearch: [{ type: Input, args: [{ isSignal: true, alias: "showSearch", required: false }] }], size: [{ type: Input, args: [{ isSignal: true, alias: "size", required: false }] }], status: [{ type: Input, args: [{ isSignal: true, alias: "status", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HrmCascader, { className: "HrmCascader", filePath: "libs/hrm-ui/src/lib/data-entry/hrm-cascader.ts", lineNumber: 30 });
})();

// apps/ds-demo/src/app/features/styleguide/pages/hrm/data-entry/cascader.ts
var SgDocCascader = class _SgDocCascader {
  constructor() {
    this.org = null;
    this.area = null;
    this.okPath = ["mn", "hcm", "hr"];
    this.orgTree = [
      {
        value: "mn",
        label: "Mi\u1EC1n Nam",
        children: [
          {
            value: "hcm",
            label: "Chi nh\xE1nh HCM",
            children: [
              { value: "hr", label: "Ph\xF2ng Nh\xE2n s\u1EF1", isLeaf: true },
              { value: "it", label: "Ph\xF2ng CNTT", isLeaf: true }
            ]
          },
          {
            value: "ct",
            label: "Chi nh\xE1nh C\u1EA7n Th\u01A1",
            children: [
              { value: "sale", label: "Ph\xF2ng Kinh doanh", isLeaf: true }
            ]
          }
        ]
      },
      {
        ...
        children: [
          {
            value: "hn",
            label: "Chi nh\xE1nh H\xE0 N\u1ED9i",
            children: [
              { value: "acc", label: "Ph\xF2ng K\u1EBF to\xE1n", isLeaf: true }
            ]
          }
        ]
      }
    ...
    this.areaTree = [
        ...
        children: [
          {
            ...
            label: "Qu\u1EADn 1",
            children: [
              { value: "bn", label: "Ph\u01B0\u1EDDng B\u1EBFn Ngh\xE9", isLeaf: true },
              { value: "bt", label: "Ph\u01B0\u1EDDng B\u1EBFn Th\xE0nh", isLeaf: true }
            ]
          }
        ]
      },
      {
        ...
        children: [
          {
            value: "bd",
            label: "Qu\u1EADn Ba \u0110\xECnh",
            children: [
              { value: "pt", label: "Ph\u01B0\u1EDDng Ph\xFAc T\xE2n", isLeaf: true }
            ]
          }
        ]
      }
  ...
  static {
    this.\u0275fac = function SgDocCascader_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SgDocCascader)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SgDocCascader, selectors: [["sg-doc-cascader"]], decls: 65, vars: 95, consts: [["category", "Data Input", 3, "title", "desc"], ["sgOverview", ""], [2, "width", "100%", "max-width", "320px"], [3, "ngModelChange", "ngModel", "options", "placeholder"], ["sgUsage", ""], [3, "purpose", "when", "behavior", "avoid"], ["sgBest", ""], ["sgExamples", ""], [3, "title", "desc"], [2, "width", "300px"], [3, "ngModelChange", "ngModel", "options", "showSearch", "placeholder"], ["label", "sm \xB7 md \xB7 lg"], [2, "width", "220px"], ["size", "sm", 3, "options", "placeholder", "ngModel"], ["size", "md", 3, "options", "placeholder", "ngModel"], ["size", "lg", 3, "options", "placeholder", "ngModel"], [2, "width", "260px"], ["status", "error", 3, "options", "placeholder", "ngModel"], ["status", "warning", 3, "options", "placeholder", "ngModel"], ["status", "success", 3, "options", "ngModel"]], template: function SgDocCascader_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "sg-doc", 0);
        \u0275\u0275pipe(1, "translate");
        \u0275\u0275pipe(2, "translate");
        \u0275\u0275elementStart(3, "div", 1)(4, "div", 2)(5, "hrm-cascader", 3);
        \u0275\u0275pipe(6, "translate");
        \u0275\u0275twoWayListener("ngModelChange", function SgDocCascader_Template_hrm_cascader_ngModelChange_5_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.org, $event) || (ctx.org = $event);
          return $event;
        });
        \u0275\u0275elementEnd()()();
        ...
        \u0275\u0275pipe(27, "translate");
        \u0275\u0275pipe(28, "translate");
        \u0275\u0275elementStart(29, "sg-row")(30, "div", 9)(31, "hrm-cascader", 3);
        \u0275\u0275pipe(32, "translate");
        \u0275\u0275twoWayListener("ngModelChange", function SgDocCascader_Template_hrm_cascader_ngModelChange_31_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.org, $event) || (ctx.org = $event);
          return $event;
        });
        \u0275\u0275elementEnd()()()();
        ...
        \u0275\u0275pipe(34, "translate");
        \u0275\u0275pipe(35, "translate");
        \u0275\u0275elementStart(36, "sg-row")(37, "div", 9)(38, "hrm-cascader", 10);
        \u0275\u0275pipe(39, "translate");
        \u0275\u0275twoWayListener("ngModelChange", function SgDocCascader_Template_hrm_cascader_ngModelChange_38_listener($event) {
        ...
        \u0275\u0275pipe(41, "translate");
        \u0275\u0275pipe(42, "translate");
        \u0275\u0275elementStart(43, "sg-row", 11)(44, "div", 12);
        \u0275\u0275element(45, "hrm-cascader", 13);
        \u0275\u0275pipe(46, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(47, "div", 12);
        \u0275\u0275element(48, "hrm-cascader", 14);
        \u0275\u0275pipe(49, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(50, "div", 12);
        \u0275\u0275element(51, "hrm-cascader", 15);
        \u0275\u0275pipe(52, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(53, "sg-example", 8);
        \u0275\u0275pipe(54, "translate");
        \u0275\u0275pipe(55, "translate");
        \u0275\u0275elementStart(56, "sg-row")(57, "div", 16);
        \u0275\u0275element(58, "hrm-cascader", 17);
        \u0275\u0275pipe(59, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(60, "div", 16);
        \u0275\u0275element(61, "hrm-cascader", 18);
        \u0275\u0275pipe(62, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(63, "div", 16);
        \u0275\u0275element(64, "hrm-cascader", 19);
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        \u0275\u0275property("title", \u0275\u0275pipeBind1(1, 45, "docs.cascader.title"))("desc", \u0275\u0275pipeBind1(2, 47, "docs.cascader.desc"));
        \u0275\u0275advance(5);
        \u0275\u0275twoWayProperty("ngModel", ctx.org);
        \u0275\u0275property("options", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(6, 49, "docs.cascader.ovPh"));
        \u0275\u0275advance(3);
        \u0275\u0275property("purpose", \u0275\u0275pipeBind1(9, 51, "docs.cascader.purpose"))("when", ctx.when)("behavior", \u0275\u0275pipeBind1(10, 53, "docs.cascader.behavior"))("avoid", \u0275\u0275pipeBind1(11, 55, "docs.cascader.avoid"));
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(15, 57, "docs.cascader.do1"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 59, "docs.cascader.do2"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 61, "docs.cascader.do3"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(24, 63, "docs.cascader.dont1"));
        \u0275\u0275advance(3);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(27, 65, "docs.cascader.exOrgT"))("desc", \u0275\u0275pipeBind1(28, 67, "docs.cascader.exOrgD"));
        \u0275\u0275advance(5);
        \u0275\u0275twoWayProperty("ngModel", ctx.org);
        \u0275\u0275property("options", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(32, 69, "docs.cascader.orgPh"));
        \u0275\u0275advance(2);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(34, 71, "docs.cascader.exAreaT"))("desc", \u0275\u0275pipeBind1(35, 73, "docs.cascader.exAreaD"));
        \u0275\u0275advance(5);
        \u0275\u0275twoWayProperty("ngModel", ctx.area);
        \u0275\u0275property("options", ctx.areaTree)("showSearch", true)("placeholder", \u0275\u0275pipeBind1(39, 75, "docs.cascader.areaPh"));
        \u0275\u0275advance(2);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(41, 77, "docs.cascader.exSizeT"))("desc", \u0275\u0275pipeBind1(42, 79, "docs.cascader.exSizeD"));
        \u0275\u0275advance(5);
        \u0275\u0275property("options", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(46, 81, "docs.cascader.small"))("ngModel", null);
        \u0275\u0275advance(3);
        \u0275\u0275property("options", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(49, 83, "docs.cascader.medium"))("ngModel", null);
        \u0275\u0275advance(3);
        \u0275\u0275property("options", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(52, 85, "docs.cascader.large"))("ngModel", null);
        \u0275\u0275advance(2);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(54, 87, "docs.cascader.exStateT"))("desc", \u0275\u0275pipeBind1(55, 89, "docs.cascader.exStateD"));
        \u0275\u0275advance(5);
        \u0275\u0275property("options", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(59, 91, "docs.cascader.errPh"))("ngModel", null);
        \u0275\u0275advance(3);
        \u0275\u0275property("options", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(62, 93, "docs.cascader.warnPh"))("ngModel", null);
        \u0275\u0275advance(3);
        \u0275\u0275property("options", ctx.orgTree)("ngModel", ctx.okPath);
      }
    }, dependencies: [FormsModule, NgControlStatus, NgModel, TranslateModule, HrmCascader, SgDoc, SgUse, SgDo, SgDont, SgExample, SgRow, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SgDocCascader, [{
    type: Component,
    args: [{
      selector: "sg-doc-cascader",
      imports: [FormsModule, TranslateModule, HrmCascader, SgDoc, SgUse, SgDo, SgDont, SgExample, SgRow],
      template: `
    <sg-doc category="Data Input" [title]="'docs.cascader.title' | translate" [desc]="'docs.cascader.desc' | translate">

      <div sgOverview>
        <div style="width:100%;max-width:320px">
          <hrm-cascader [(ngModel)]="org" [options]="orgTree" [placeholder]="'docs.cascader.ovPh' | translate" />
        </div>
      </div>

      <div sgUsage>
        <sg-use
          [purpose]="'docs.cascader.purpose' | translate"
          [when]="when"
          [behavior]="'docs.cascader.behavior' | translate"
          [avoid]="'docs.cascader.avoid' | translate" />
      </div>

      <div sgBest>
        <sg-do>{{ 'docs.cascader.do1' | translate }}</sg-do>
        <sg-do>{{ 'docs.cascader.do2' | translate }}</sg-do>
        <sg-do>{{ 'docs.cascader.do3' | translate }}</sg-do>
        <sg-dont>{{ 'docs.cascader.dont1' | translate }}</sg-dont>
      </div>

      <div sgExamples>
        <sg-example [title]="'docs.cascader.exOrgT' | translate"
          [desc]="'docs.cascader.exOrgD' | translate">
          <sg-row>
            <div style="width:300px"><hrm-cascader [(ngModel)]="org" [options]="orgTree" [placeholder]="'docs.cascader.orgPh' | translate" /></div>
          </sg-row>
        </sg-example>

        <sg-example [title]="'docs.cascader.exAreaT' | translate"
          [desc]="'docs.cascader.exAreaD' | translate">
          <sg-row>
            <div style="width:300px"><hrm-cascader [(ngModel)]="area" [options]="areaTree" [showSearch]="true" [placeholder]="'docs.cascader.areaPh' | translate" /></div>
          </sg-row>
        </sg-example>

        <sg-example [title]="'docs.cascader.exSizeT' | translate"
          [desc]="'docs.cascader.exSizeD' | translate">
          <sg-row label="sm \xB7 md \xB7 lg">
            <div style="width:220px"><hrm-cascader size="sm" [options]="orgTree" [placeholder]="'docs.cascader.small' | translate" [ngModel]="null" /></div>
            <div style="width:220px"><hrm-cascader size="md" [options]="orgTree" [placeholder]="'docs.cascader.medium' | translate" [ngModel]="null" /></div>
            <div style="width:220px"><hrm-cascader size="lg" [options]="orgTree" [placeholder]="'docs.cascader.large' | translate" [ngModel]="null" /></div>
          </sg-row>
        </sg-example>

        <sg-example [title]="'docs.cascader.exStateT' | translate"
          [desc]="'docs.cascader.exStateD' | translate">
          <sg-row>
            <div style="width:260px"><hrm-cascader status="error" [options]="orgTree" [placeholder]="'docs.cascader.errPh' | translate" [ngModel]="null" /></div>
            <div style="width:260px"><hrm-cascader status="warning" [options]="orgTree" [placeholder]="'docs.cascader.warnPh' | translate" [ngModel]="null" /></div>
            <div style="width:260px"><hrm-cascader status="success" [options]="orgTree" [ngModel]="okPath" /></div>
          </sg-row>
        </sg-example>
      </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SgDocCascader, { className: "SgDocCascader", filePath: "apps/ds-demo/src/app/features/styleguide/pages/hrm/data-entry/cascader.ts", lineNumber: 73 });
})();
export {
  SgDocCascader
};
//# sourceMappingURL=chunk-ARUABZG2.js.map
