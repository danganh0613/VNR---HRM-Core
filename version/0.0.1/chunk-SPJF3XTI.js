...
var _c5 = ["tplDetail"];
var _c6 = () => ["table"];
function SgDocDataView_ng_template_54_For_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "hrm-tag", 32);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SgDocDataView_ng_template_54_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22)(1, "div", 23);
    \u0275\u0275element(2, "hrm-user-cell", 24);
    \u0275\u0275elementStart(3, "hrm-tag", 25);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 26)(6, "span", 27);
    \u0275\u0275text(7, "KPI");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(13, SgDocDataView_ng_template_54_For_14_Template, 2, 1, "hrm-tag", 32, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function SgDocDataView_ng_template_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "hrm-user-cell", 24);
  }
  if (rf & 2) {
...
function SgDocDataView_ng_template_58_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "hrm-tags-cell", 33);
  }
  if (rf & 2) {
...
function SgDocDataView_ng_template_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "hrm-progress-cell", 34);
  }
  if (rf & 2) {
...
function SgDocDataView_ng_template_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "hrm-status-cell", 35);
  }
  if (rf & 2) {
...
function SgDocDataView_ng_template_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "sg-employee-detail", 36);
  }
  if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SgDocDataView, selectors: [["sg-doc-data-view"]], viewQuery: function SgDocDataView_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275template(54, SgDocDataView_ng_template_54_Template, 15, 10, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(56, SgDocDataView_ng_template_56_Template, 1, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(58, SgDocDataView_ng_template_58_Template, 1, 2, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(60, SgDocDataView_ng_template_60_Template, 1, 2, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(62, SgDocDataView_ng_template_62_Template, 1, 2, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(64, SgDocDataView_ng_template_64_Template, 1, 1, "ng-template", null, 5, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        ...
        \u0275\u0275advance(23);
        \u0275\u0275property("columns", ctx.columns())("data", ctx.data.slice(0, 4))("viewModes", \u0275\u0275pureFunction0(22, _c6))("detailContent", ctx.detailTpl())("detailRoute", ctx.routeFor)("modeLabels", ctx.modeLabels);
      }
    }, dependencies: [
      HrmListScreen,
      HrmUserCell,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SgDocDataView, { className: "SgDocDataView", filePath: "apps/ds-demo/src/app/features/styleguide/pages/hrm/table-list/data-view.ts", lineNumber: 123 });
})();
export {
  SgDocDataView
};
//# sourceMappingURL=chunk-SPJF3XTI.js.map
