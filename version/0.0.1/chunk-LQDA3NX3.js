...
function NzTreeSelectComponent_ng_template_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("nzNoAnimation", !!(ctx_r1.noAnimation == null ? null : ctx_r1.noAnimation.nzNoAnimation == null ? null : ctx_r1.noAnimation.nzNoAnimation()))("dir", ctx_r1.dir());
    \u0275\u0275advance();
  ...
  return class NzTreeSelectComponent2 extends _classSuper {
    ...
    static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
      ...
      viewQuery: function NzTreeSelectComponent_Query(rf, ctx) {
        if (rf & 1) {
          \u0275\u0275viewQuery(NzSelectSearchComponent, 5)(_c12, 5)(CdkOverlayOrigin, 7)(CdkConnectedOverlay, 5);
        }
        if (rf & 2) {
          let _t;
      ...
      hostBindings: function NzTreeSelectComponent_HostBindings(rf, ctx) {
        ...
        if (rf & 2) {
          \u0275\u0275classProp("ant-select-in-form-item", !!ctx.nzFormStatusService)("ant-select-rtl", ctx.dir() === "rtl")("ant-select-lg", ctx.finalSize() === "large")("ant-select-sm", ctx.finalSize() === "small")("ant-select-disabled", ctx.nzDisabled)("ant-select-single", !ctx.isMultiple)("ant-select-show-arrow", !ctx.isMultiple)("ant-select-show-search", !ctx.isMultiple)("ant-select-borderless", ctx.finalVariant() === "borderless")("ant-select-filled", ctx.finalVariant() === "filled")("ant-select-underlined", ctx.finalVariant() === "underlined")("ant-select-multiple", ctx.isMultiple)("ant-select-allow-clear", ctx.nzAllowClear)("ant-select-open", ctx.nzOpen)("ant-select-focused", ctx.nzOpen || ctx.focused);
        }
      },
      inputs: {
        nzId: "nzId",
...
// libs/hrm-ui/src/lib/data-entry/hrm-tree-select.ts
var toNz = (s) => s === "sm" ? "small" : s === "lg" ? "large" : "default";
var HrmTreeSelect = class _HrmTreeSelect extends HrmControl {
  constructor() {
    super(...arguments);
  ...
  static {
    this.\u0275fac = /* @__PURE__ */ (() => {
      let \u0275HrmTreeSelect_BaseFactory;
      return function HrmTreeSelect_Factory(__ngFactoryType__) {
        return (\u0275HrmTreeSelect_BaseFactory || (\u0275HrmTreeSelect_BaseFactory = \u0275\u0275getInheritedFactory(_HrmTreeSelect)))(__ngFactoryType__ || _HrmTreeSelect);
      };
    })();
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HrmTreeSelect, selectors: [["hrm-tree-select"]], hostAttrs: [1, "hrm-tree-select"], hostVars: 2, hostBindings: function HrmTreeSelect_HostBindings(rf, ctx) {
      if (rf & 2) {
        \u0275\u0275classProp("hrm-status-success", ctx.status() === "success");
      }
    }, inputs: { nodes: [1, "nodes"], placeholder: [1, "placeholder"], multiple: [1, "multiple"], allowClear: [1, "allowClear"], showSearch: [1, "showSearch"], size: [1, "size"], status: [1, "status"] }, features: [\u0275\u0275ProvidersFeature([{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => _HrmTreeSelect), multi: true }]), \u0275\u0275InheritDefinitionFeature], decls: 1, vars: 9, consts: [[2, "width", "100%", 3, "ngModelChange", "ngModel", "nzNodes", "nzPlaceHolder", "nzMultiple", "nzAllowClear", "nzShowSearch", "nzDisabled", "nzSize", "nzStatus"]], template: function HrmTreeSelect_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "nz-tree-select", 0);
        \u0275\u0275listener("ngModelChange", function HrmTreeSelect_Template_nz_tree_select_ngModelChange_0_listener($event) {
          return ctx.emit($event);
        });
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275property("ngModel", ctx.value())("nzNodes", ctx.nodes())("nzPlaceHolder", ctx.placeholder())("nzMultiple", ctx.multiple())("nzAllowClear", ctx.allowClear())("nzShowSearch", ctx.showSearch())("nzDisabled", ctx.disabled())("nzSize", ctx.toNz(ctx.size()))("nzStatus", ctx.toNzStatus(ctx.status()));
      }
    }, dependencies: [FormsModule, NgControlStatus, NgModel, NzTreeSelectModule, NzTreeSelectComponent], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HrmTreeSelect, [{
    type: Component,
    args: [{
      selector: "hrm-tree-select",
    ...
    <nz-tree-select
      ...
      [nzDisabled]="disabled()"
      [nzSize]="toNz(size())"
      [nzStatus]="toNzStatus(status())"></nz-tree-select>
  `,
      host: { class: "hrm-tree-select", "[class.hrm-status-success]": "status() === 'success'" },
      providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => HrmTreeSelect), multi: true }]
    }]
  }], null, { nodes: [{ type: Input, args: [{ isSignal: true, alias: "nodes", required: false }] }], placeholder: [{ type: Input, args: [{ isSignal: true, alias: "placeholder", required: false }] }], multiple: [{ type: Input, args: [{ isSignal: true, alias: "multiple", required: false }] }], allowClear: [{ type: Input, args: [{ isSignal: true, alias: "allowClear", required: false }] }], showSearch: [{ type: Input, args: [{ isSignal: true, alias: "showSearch", required: false }] }], size: [{ type: Input, args: [{ isSignal: true, alias: "size", required: false }] }], status: [{ type: Input, args: [{ isSignal: true, alias: "status", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HrmTreeSelect, { className: "HrmTreeSelect", filePath: "libs/hrm-ui/src/lib/data-entry/hrm-tree-select.ts", lineNumber: 31 });
})();

// apps/ds-demo/src/app/features/styleguide/pages/hrm/data-entry/tree-select.ts
var SgDocTreeSelect = class _SgDocTreeSelect {
  constructor() {
    this.dept = null;
    this.groups = [];
    this.when = [
      "docs.treeSelect.when1",
      "docs.treeSelect.when2",
      "docs.treeSelect.when3"
    ];
    this.orgTree = [
      {
        title: "C\xF4ng ty CP ABC",
        key: "cong-ty",
        expanded: true,
        children: [
          {
            title: "Kh\u1ED1i H\xE0nh ch\xEDnh \u2013 Nh\xE2n s\u1EF1",
            key: "khoi-hcns",
            children: [
              { title: "Ph\xF2ng Nh\xE2n s\u1EF1", key: "phong-nhan-su", isLeaf: true },
              { title: "Ph\xF2ng H\xE0nh ch\xEDnh", key: "phong-hanh-chinh", isLeaf: true }
            ]
          },
          {
            ...
            key: "khoi-kinh-doanh",
            children: [
              { title: "Ph\xF2ng Kinh doanh 1", key: "phong-kd-1", isLeaf: true },
              { title: "Ph\xF2ng Kinh doanh 2", key: "phong-kd-2", isLeaf: true }
            ]
          }
        ]
      }
    ...
    this.jobTree = [
      {
        title: "To\xE0n b\u1ED9 ch\u1EE9c danh",
        key: "all",
        expanded: true,
        children: [
          {
            title: "Kh\u1ED1i v\u0103n ph\xF2ng",
            key: "van-phong",
            children: [
              { title: "Chuy\xEAn vi\xEAn", key: "chuyen-vien", isLeaf: true },
              { title: "Tr\u01B0\u1EDFng nh\xF3m", key: "truong-nhom", isLeaf: true },
              { title: "Tr\u01B0\u1EDFng ph\xF2ng", key: "truong-phong", isLeaf: true }
            ]
          },
          {
            title: "Kh\u1ED1i s\u1EA3n xu\u1EA5t",
            key: "san-xuat",
            children: [
              { title: "C\xF4ng nh\xE2n", key: "cong-nhan", isLeaf: true },
              { title: "T\u1ED5 tr\u01B0\u1EDFng", key: "to-truong", isLeaf: true }
            ]
          }
        ]
      }
  ...
  static {
    this.\u0275fac = function SgDocTreeSelect_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SgDocTreeSelect)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SgDocTreeSelect, selectors: [["sg-doc-tree-select"]], decls: 65, vars: 95, consts: [["category", "Data Input", 3, "title", "desc"], ["sgOverview", ""], [2, "width", "100%", "max-width", "300px"], [3, "ngModelChange", "ngModel", "nodes", "placeholder"], ["sgUsage", ""], [3, "purpose", "when", "behavior", "avoid"], ["sgBest", ""], [3, "innerHTML"], ["sgExamples", ""], [3, "title", "desc"], [2, "width", "300px"], [2, "width", "340px"], [3, "ngModelChange", "ngModel", "nodes", "multiple", "placeholder"], ["label", "sm \xB7 md \xB7 lg"], [2, "width", "220px"], ["size", "sm", 3, "nodes", "placeholder", "ngModel"], ["size", "md", 3, "nodes", "placeholder", "ngModel"], ["size", "lg", 3, "nodes", "placeholder", "ngModel"], [2, "width", "240px"], ["status", "error", 3, "nodes", "placeholder", "ngModel"], ["status", "warning", 3, "nodes", "placeholder", "ngModel"], ["status", "success", 3, "nodes", "ngModel"]], template: function SgDocTreeSelect_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "sg-doc", 0);
        \u0275\u0275pipe(1, "translate");
        \u0275\u0275pipe(2, "translate");
        \u0275\u0275elementStart(3, "div", 1)(4, "div", 2)(5, "hrm-tree-select", 3);
        \u0275\u0275pipe(6, "translate");
        \u0275\u0275twoWayListener("ngModelChange", function SgDocTreeSelect_Template_hrm_tree_select_ngModelChange_5_listener($event) {
        ...
        \u0275\u0275pipe(27, "translate");
        \u0275\u0275pipe(28, "translate");
        \u0275\u0275elementStart(29, "sg-row")(30, "div", 10)(31, "hrm-tree-select", 3);
        \u0275\u0275pipe(32, "translate");
        \u0275\u0275twoWayListener("ngModelChange", function SgDocTreeSelect_Template_hrm_tree_select_ngModelChange_31_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.dept, $event) || (ctx.dept = $event);
          return $event;
        });
        \u0275\u0275elementEnd()()()();
        ...
        \u0275\u0275pipe(34, "translate");
        \u0275\u0275pipe(35, "translate");
        \u0275\u0275elementStart(36, "sg-row")(37, "div", 11)(38, "hrm-tree-select", 12);
        \u0275\u0275pipe(39, "translate");
        \u0275\u0275twoWayListener("ngModelChange", function SgDocTreeSelect_Template_hrm_tree_select_ngModelChange_38_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.groups, $event) || (ctx.groups = $event);
          return $event;
        });
        \u0275\u0275elementEnd()()()();
        ...
        \u0275\u0275pipe(41, "translate");
        \u0275\u0275pipe(42, "translate");
        \u0275\u0275elementStart(43, "sg-row", 13)(44, "div", 14);
        \u0275\u0275element(45, "hrm-tree-select", 15);
        \u0275\u0275pipe(46, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(47, "div", 14);
        \u0275\u0275element(48, "hrm-tree-select", 16);
        \u0275\u0275pipe(49, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(50, "div", 14);
        \u0275\u0275element(51, "hrm-tree-select", 17);
        \u0275\u0275pipe(52, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(53, "sg-example", 9);
        \u0275\u0275pipe(54, "translate");
        \u0275\u0275pipe(55, "translate");
        \u0275\u0275elementStart(56, "sg-row")(57, "div", 18);
        \u0275\u0275element(58, "hrm-tree-select", 19);
        \u0275\u0275pipe(59, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(60, "div", 18);
        \u0275\u0275element(61, "hrm-tree-select", 20);
        \u0275\u0275pipe(62, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(63, "div", 18);
        \u0275\u0275element(64, "hrm-tree-select", 21);
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        \u0275\u0275property("title", \u0275\u0275pipeBind1(1, 45, "docs.treeSelect.title"))("desc", \u0275\u0275pipeBind1(2, 47, "docs.treeSelect.desc"));
        \u0275\u0275advance(5);
        \u0275\u0275twoWayProperty("ngModel", ctx.dept);
        \u0275\u0275property("nodes", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(6, 49, "docs.treeSelect.ovPh"));
        \u0275\u0275advance(3);
        \u0275\u0275property("purpose", \u0275\u0275pipeBind1(9, 51, "docs.treeSelect.purpose"))("when", ctx.when)("behavior", \u0275\u0275pipeBind1(10, 53, "docs.treeSelect.behavior"))("avoid", \u0275\u0275pipeBind1(11, 55, "docs.treeSelect.avoid"));
        \u0275\u0275advance(6);
        \u0275\u0275property("innerHTML", \u0275\u0275pipeBind1(15, 57, "docs.treeSelect.do1"), \u0275\u0275sanitizeHtml);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 59, "docs.treeSelect.do2"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 61, "docs.treeSelect.do3"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(24, 63, "docs.treeSelect.dont1"));
        \u0275\u0275advance(3);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(27, 65, "docs.treeSelect.exDeptT"))("desc", \u0275\u0275pipeBind1(28, 67, "docs.treeSelect.exDeptD"));
        \u0275\u0275advance(5);
        \u0275\u0275twoWayProperty("ngModel", ctx.dept);
        \u0275\u0275property("nodes", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(32, 69, "docs.treeSelect.ovPh"));
        \u0275\u0275advance(2);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(34, 71, "docs.treeSelect.exMultiT"))("desc", \u0275\u0275pipeBind1(35, 73, "docs.treeSelect.exMultiD"));
        \u0275\u0275advance(5);
        \u0275\u0275twoWayProperty("ngModel", ctx.groups);
        \u0275\u0275property("nodes", ctx.jobTree)("multiple", true)("placeholder", \u0275\u0275pipeBind1(39, 75, "docs.treeSelect.jobPh"));
        \u0275\u0275advance(2);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(41, 77, "docs.treeSelect.exSizeT"))("desc", \u0275\u0275pipeBind1(42, 79, "docs.treeSelect.exSizeD"));
        \u0275\u0275advance(5);
        \u0275\u0275property("nodes", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(46, 81, "docs.treeSelect.small"))("ngModel", null);
        \u0275\u0275advance(3);
        \u0275\u0275property("nodes", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(49, 83, "docs.treeSelect.medium"))("ngModel", null);
        \u0275\u0275advance(3);
        \u0275\u0275property("nodes", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(52, 85, "docs.treeSelect.large"))("ngModel", null);
        \u0275\u0275advance(2);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(54, 87, "docs.treeSelect.exStateT"))("desc", \u0275\u0275pipeBind1(55, 89, "docs.treeSelect.exStateD"));
        \u0275\u0275advance(5);
        \u0275\u0275property("nodes", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(59, 91, "docs.treeSelect.errPh"))("ngModel", null);
        \u0275\u0275advance(3);
        \u0275\u0275property("nodes", ctx.orgTree)("placeholder", \u0275\u0275pipeBind1(62, 93, "docs.treeSelect.warnPh"))("ngModel", null);
        \u0275\u0275advance(3);
        \u0275\u0275property("nodes", ctx.orgTree)("ngModel", "phong-nhan-su");
      }
    }, dependencies: [FormsModule, NgControlStatus, NgModel, TranslateModule, HrmTreeSelect, SgDoc, SgUse, SgDo, SgDont, SgExample, SgRow, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SgDocTreeSelect, [{
    type: Component,
    args: [{
      selector: "sg-doc-tree-select",
      imports: [FormsModule, TranslateModule, HrmTreeSelect, SgDoc, SgUse, SgDo, SgDont, SgExample, SgRow],
      template: `
    <sg-doc category="Data Input" [title]="'docs.treeSelect.title' | translate" [desc]="'docs.treeSelect.desc' | translate">

      <div sgOverview>
        <div style="width:100%;max-width:300px">
          <hrm-tree-select [(ngModel)]="dept" [nodes]="orgTree" [placeholder]="'docs.treeSelect.ovPh' | translate" />
        </div>
      </div>

      <div sgUsage>
        <sg-use
          [purpose]="'docs.treeSelect.purpose' | translate"
          [when]="when"
          [behavior]="'docs.treeSelect.behavior' | translate"
          [avoid]="'docs.treeSelect.avoid' | translate" />
      </div>

      <div sgBest>
        <sg-do><span [innerHTML]="'docs.treeSelect.do1' | translate"></span></sg-do>
        <sg-do>{{ 'docs.treeSelect.do2' | translate }}</sg-do>
        <sg-do>{{ 'docs.treeSelect.do3' | translate }}</sg-do>
        <sg-dont>{{ 'docs.treeSelect.dont1' | translate }}</sg-dont>
      </div>

      <div sgExamples>
        <sg-example [title]="'docs.treeSelect.exDeptT' | translate"
          [desc]="'docs.treeSelect.exDeptD' | translate">
          <sg-row>
            <div style="width:300px"><hrm-tree-select [(ngModel)]="dept" [nodes]="orgTree" [placeholder]="'docs.treeSelect.ovPh' | translate" /></div>
          </sg-row>
        </sg-example>

        <sg-example [title]="'docs.treeSelect.exMultiT' | translate"
          [desc]="'docs.treeSelect.exMultiD' | translate">
          <sg-row>
            <div style="width:340px"><hrm-tree-select [(ngModel)]="groups" [nodes]="jobTree" [multiple]="true" [placeholder]="'docs.treeSelect.jobPh' | translate" /></div>
          </sg-row>
        </sg-example>

        <sg-example [title]="'docs.treeSelect.exSizeT' | translate"
          [desc]="'docs.treeSelect.exSizeD' | translate">
          <sg-row label="sm \xB7 md \xB7 lg">
            <div style="width:220px"><hrm-tree-select size="sm" [nodes]="orgTree" [placeholder]="'docs.treeSelect.small' | translate" [ngModel]="null" /></div>
            <div style="width:220px"><hrm-tree-select size="md" [nodes]="orgTree" [placeholder]="'docs.treeSelect.medium' | translate" [ngModel]="null" /></div>
            <div style="width:220px"><hrm-tree-select size="lg" [nodes]="orgTree" [placeholder]="'docs.treeSelect.large' | translate" [ngModel]="null" /></div>
          </sg-row>
        </sg-example>

        <sg-example [title]="'docs.treeSelect.exStateT' | translate"
          [desc]="'docs.treeSelect.exStateD' | translate">
          <sg-row>
            <div style="width:240px"><hrm-tree-select status="error" [nodes]="orgTree" [placeholder]="'docs.treeSelect.errPh' | translate" [ngModel]="null" /></div>
            <div style="width:240px"><hrm-tree-select status="warning" [nodes]="orgTree" [placeholder]="'docs.treeSelect.warnPh' | translate" [ngModel]="null" /></div>
            <div style="width:240px"><hrm-tree-select status="success" [nodes]="orgTree" [ngModel]="'phong-nhan-su'" /></div>
          </sg-row>
        </sg-example>
      </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SgDocTreeSelect, { className: "SgDocTreeSelect", filePath: "apps/ds-demo/src/app/features/styleguide/pages/hrm/data-entry/tree-select.ts", lineNumber: 73 });
})();
export {
  SgDocTreeSelect
};
//# sourceMappingURL=chunk-LQDA3NX3.js.map
