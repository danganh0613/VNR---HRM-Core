...
// libs/hrm-ui/src/lib/data-entry/hrm-upload.ts
var _c02 = ["*"];
var HrmUpload = class _HrmUpload {
  constructor() {
    this.type = input("select", ...ngDevMode ? [{ debugName: "type" }] : (
    ...
    this.listType = input("text", ...ngDevMode ? [{ debugName: "listType" }] : (
      /* istanbul ignore next */
      []
    ));
    this.maxCount = input(void 0, ...ngDevMode ? [{ debugName: "maxCount" }] : (
      /* istanbul ignore next */
      []
    ));
    this.fileList = input([], ...ngDevMode ? [{ debugName: "fileList" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  static {
    this.\u0275fac = function HrmUpload_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _HrmUpload)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HrmUpload, selectors: [["hrm-upload"]], hostAttrs: [1, "hrm-upload"], inputs: { type: [1, "type"], action: [1, "action"], multiple: [1, "multiple"], accept: [1, "accept"], listType: [1, "listType"], maxCount: [1, "maxCount"], fileList: [1, "fileList"], disabled: [1, "disabled"] }, outputs: { changed: "changed" }, ngContentSelectors: _c02, decls: 2, vars: 8, consts: [[3, "nzChange", "nzType", "nzAction", "nzMultiple", "nzAccept", "nzListType", "nzMaxCount", "nzFileList", "nzDisabled"]], template: function HrmUpload_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275projectionDef();
        \u0275\u0275elementStart(0, "nz-upload", 0);
        \u0275\u0275listener("nzChange", function HrmUpload_Template_nz_upload_nzChange_0_listener($event) {
      ...
      if (rf & 2) {
        \u0275\u0275property("nzType", ctx.type())("nzAction", ctx.action())("nzMultiple", ctx.multiple())("nzAccept", ctx.accept())("nzListType", ctx.listType())("nzMaxCount", ctx.maxCount())("nzFileList", ctx.fileList())("nzDisabled", ctx.disabled());
      }
    }, dependencies: [NzUploadModule, NzUploadComponent], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HrmUpload, [{
    type: Component,
    args: [{
      selector: "hrm-upload",
    ...
    <nz-upload
      ...
      [nzFileList]="fileList()"
      [nzDisabled]="disabled()"
      (nzChange)="changed.emit($event)">
      <ng-content />
    </nz-upload>
  `,
      host: { class: "hrm-upload" }
    }]
  }], null, { type: [{ type: Input, args: [{ isSignal: true, alias: "type", required: false }] }], action: [{ type: Input, args: [{ isSignal: true, alias: "action", required: false }] }], multiple: [{ type: Input, args: [{ isSignal: true, alias: "multiple", required: false }] }], accept: [{ type: Input, args: [{ isSignal: true, alias: "accept", required: false }] }], listType: [{ type: Input, args: [{ isSignal: true, alias: "listType", required: false }] }], maxCount: [{ type: Input, args: [{ isSignal: true, alias: "maxCount", required: false }] }], fileList: [{ type: Input, args: [{ isSignal: true, alias: "fileList", required: false }] }], disabled: [{ type: Input, args: [{ isSignal: true, alias: "disabled", required: false }] }], changed: [{ type: Output, args: ["changed"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HrmUpload, { className: "HrmUpload", filePath: "libs/hrm-ui/src/lib/data-entry/hrm-upload.ts", lineNumber: 24 });
})();

// apps/ds-demo/src/app/features/styleguide/pages/hrm/data-entry/upload.ts
var SgDocUpload = class _SgDocUpload {
  constructor() {
    ...
    this.avatarList = [
      { uid: "-1", name: "anh-dai-dien.png", status: "done", url: "https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png" }
    ];
  }
  static {
    this.\u0275fac = function SgDocUpload_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SgDocUpload)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SgDocUpload, selectors: [["sg-doc-upload"]], decls: 71, vars: 87, consts: [["category", "Data Input", 3, "title", "desc"], ["sgOverview", ""], ["action", "https://example.com/upload", "accept", ".pdf,.jpg,.png"], ["variant", "default"], [3, "icon", "size"], ["sgUsage", ""], [3, "purpose", "when", "behavior", "avoid"], ["sgBest", ""], [3, "innerHTML"], ["sgExamples", ""], [3, "title", "desc"], ["action", "https://example.com/upload", "accept", ".pdf,.doc,.docx"], [2, "width", "100%", "max-width", "420px"], ["type", "drag", "action", "https://example.com/upload", "accept", ".pdf,.jpg,.png", 3, "multiple"], [2, "margin", "0 0 8px"], [2, "margin", "0", "font-size", "var(--fs-14)"], [2, "margin", "4px 0 0", "font-size", "var(--fs-12)", "color", "var(--text-sub)"], ["listType", "picture-card", "action", "https://example.com/upload", "accept", "image/*", 3, "fileList"], [2, "margin-top", "4px", "font-size", "var(--fs-12)"], [3, "label"], ["action", "https://example.com/upload", "accept", ".pdf", 3, "multiple", "maxCount"]], template: function SgDocUpload_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "sg-doc", 0);
        \u0275\u0275pipe(1, "translate");
        \u0275\u0275pipe(2, "translate");
        \u0275\u0275elementStart(3, "div", 1)(4, "hrm-upload", 2)(5, "hrm-button", 3);
        \u0275\u0275element(6, "tabler-icon", 4);
        \u0275\u0275text(7);
        \u0275\u0275pipe(8, "translate");
        \u0275\u0275elementEnd()()();
        ...
        \u0275\u0275pipe(29, "translate");
        \u0275\u0275pipe(30, "translate");
        \u0275\u0275elementStart(31, "sg-row")(32, "hrm-upload", 11)(33, "hrm-button", 3);
        \u0275\u0275element(34, "tabler-icon", 4);
        \u0275\u0275text(35);
        \u0275\u0275pipe(36, "translate");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(37, "sg-example", 10);
        \u0275\u0275pipe(38, "translate");
        \u0275\u0275pipe(39, "translate");
        \u0275\u0275elementStart(40, "sg-row")(41, "div", 12)(42, "hrm-upload", 13)(43, "p", 14);
        \u0275\u0275element(44, "tabler-icon", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(45, "p", 15);
        \u0275\u0275text(46);
        \u0275\u0275pipe(47, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(48, "p", 16);
        \u0275\u0275text(49);
        \u0275\u0275pipe(50, "translate");
        \u0275\u0275elementEnd()()()()();
        ...
        \u0275\u0275pipe(52, "translate");
        \u0275\u0275pipe(53, "translate");
        \u0275\u0275elementStart(54, "sg-row")(55, "hrm-upload", 17)(56, "div");
        \u0275\u0275element(57, "tabler-icon", 4);
        ...
        \u0275\u0275pipe(62, "translate");
        \u0275\u0275pipe(63, "translate");
        \u0275\u0275elementStart(64, "sg-row", 19);
        \u0275\u0275pipe(65, "translate");
        \u0275\u0275elementStart(66, "hrm-upload", 20)(67, "hrm-button", 3);
        \u0275\u0275element(68, "tabler-icon", 4);
        \u0275\u0275text(69);
        \u0275\u0275pipe(70, "translate");
        \u0275\u0275elementEnd()()()()()();
      }
      if (rf & 2) {
        \u0275\u0275property("title", \u0275\u0275pipeBind1(1, 39, "docs.upload.title"))("desc", \u0275\u0275pipeBind1(2, 41, "docs.upload.desc"));
        \u0275\u0275advance(6);
        \u0275\u0275property("icon", ctx.paperclip)("size", 16);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 43, "docs.upload.chooseFile"));
        \u0275\u0275advance(3);
        \u0275\u0275property("purpose", \u0275\u0275pipeBind1(11, 45, "docs.upload.purpose"))("when", ctx.when)("behavior", \u0275\u0275pipeBind1(12, 47, "docs.upload.behavior"))("avoid", \u0275\u0275pipeBind1(13, 49, "docs.upload.avoid"));
        \u0275\u0275advance(6);
        \u0275\u0275property("innerHTML", \u0275\u0275pipeBind1(17, 51, "docs.upload.do1"), \u0275\u0275sanitizeHtml);
        \u0275\u0275advance(3);
        \u0275\u0275property("innerHTML", \u0275\u0275pipeBind1(20, 53, "docs.upload.do2"), \u0275\u0275sanitizeHtml);
        \u0275\u0275advance(3);
        \u0275\u0275property("innerHTML", \u0275\u0275pipeBind1(23, 55, "docs.upload.do3"), \u0275\u0275sanitizeHtml);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(26, 57, "docs.upload.dont1"));
        \u0275\u0275advance(3);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(29, 59, "docs.upload.exBtnT"))("desc", \u0275\u0275pipeBind1(30, 61, "docs.upload.exBtnD"));
        \u0275\u0275advance(6);
        \u0275\u0275property("icon", ctx.paperclip)("size", 16);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(36, 63, "docs.upload.attachDoc"));
        \u0275\u0275advance(2);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(38, 65, "docs.upload.exDragT"))("desc", \u0275\u0275pipeBind1(39, 67, "docs.upload.exDragD"));
        \u0275\u0275advance(5);
        \u0275\u0275property("multiple", true);
        \u0275\u0275advance(2);
        \u0275\u0275property("icon", ctx.cloudUpload)("size", 40);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(47, 69, "docs.upload.dragText"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(50, 71, "docs.upload.dragHint"));
        \u0275\u0275advance(2);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(52, 73, "docs.upload.exAvatarT"))("desc", \u0275\u0275pipeBind1(53, 75, "docs.upload.exAvatarD"));
        \u0275\u0275advance(4);
        \u0275\u0275property("fileList", ctx.avatarList);
        \u0275\u0275advance(2);
        \u0275\u0275property("icon", ctx.upload)("size", 18);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(60, 77, "docs.upload.uploadImage"));
        \u0275\u0275advance(2);
        \u0275\u0275property("title", \u0275\u0275pipeBind1(62, 79, "docs.upload.exLimitT"))("desc", \u0275\u0275pipeBind1(63, 81, "docs.upload.exLimitD"));
        \u0275\u0275advance(3);
        \u0275\u0275property("label", \u0275\u0275pipeBind1(65, 83, "docs.upload.limitRow"));
        \u0275\u0275advance(2);
        \u0275\u0275property("multiple", true)("maxCount", 3);
        \u0275\u0275advance(2);
        \u0275\u0275property("icon", ctx.paperclip)("size", 16);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(70, 85, "docs.upload.uploadPdf"));
      }
    }, dependencies: [TablerIconComponent, TranslateModule, HrmUpload, HrmButton, SgDoc, SgUse, SgDo, SgDont, SgExample, SgRow, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SgDocUpload, [{
    type: Component,
    args: [{
      selector: "sg-doc-upload",
      imports: [TablerIconComponent, TranslateModule, HrmUpload, HrmButton, SgDoc, SgUse, SgDo, SgDont, SgExample, SgRow],
      template: `
    <sg-doc category="Data Input" [title]="'docs.upload.title' | translate" [desc]="'docs.upload.desc' | translate">

      <div sgOverview>
        <hrm-upload action="https://example.com/upload" accept=".pdf,.jpg,.png">
          <hrm-button variant="default"><tabler-icon [icon]="$any(paperclip)" [size]="16" />{{ 'docs.upload.chooseFile' | translate }}</hrm-button>
        </hrm-upload>
      </div>

      <div sgUsage>
        <sg-use
          [purpose]="'docs.upload.purpose' | translate"
          [when]="when"
          [behavior]="'docs.upload.behavior' | translate"
          [avoid]="'docs.upload.avoid' | translate" />
      </div>

      <div sgBest>
        <sg-do><span [innerHTML]="'docs.upload.do1' | translate"></span></sg-do>
        <sg-do><span [innerHTML]="'docs.upload.do2' | translate"></span></sg-do>
        <sg-do><span [innerHTML]="'docs.upload.do3' | translate"></span></sg-do>
        <sg-dont>{{ 'docs.upload.dont1' | translate }}</sg-dont>
      </div>

      <div sgExamples>
        <sg-example [title]="'docs.upload.exBtnT' | translate"
          [desc]="'docs.upload.exBtnD' | translate">
          <sg-row>
            <hrm-upload action="https://example.com/upload" accept=".pdf,.doc,.docx">
              <hrm-button variant="default"><tabler-icon [icon]="$any(paperclip)" [size]="16" />{{ 'docs.upload.attachDoc' | translate }}</hrm-button>
            </hrm-upload>
          </sg-row>
        </sg-example>

        <sg-example [title]="'docs.upload.exDragT' | translate"
          [desc]="'docs.upload.exDragD' | translate">
          <sg-row>
            <div style="width:100%;max-width:420px">
              <hrm-upload type="drag" action="https://example.com/upload" [multiple]="true" accept=".pdf,.jpg,.png">
                <p style="margin:0 0 8px"><tabler-icon [icon]="$any(cloudUpload)" [size]="40" /></p>
                <p style="margin:0;font-size: var(--fs-14)">{{ 'docs.upload.dragText' | translate }}</p>
                <p style="margin:4px 0 0;font-size: var(--fs-12);color:var(--text-sub)">{{ 'docs.upload.dragHint' | translate }}</p>
              </hrm-upload>
            </div>
          </sg-row>
        </sg-example>

        <sg-example [title]="'docs.upload.exAvatarT' | translate"
          [desc]="'docs.upload.exAvatarD' | translate">
          <sg-row>
            <hrm-upload
              ...
              accept="image/*"
              [fileList]="avatarList">
              <div><tabler-icon [icon]="$any(upload)" [size]="18" /><div style="margin-top:4px;font-size: var(--fs-12)">{{ 'docs.upload.uploadImage' | translate }}</div></div>
            </hrm-upload>
          </sg-row>
        </sg-example>

        <sg-example [title]="'docs.upload.exLimitT' | translate"
          [desc]="'docs.upload.exLimitD' | translate">
          <sg-row [label]="'docs.upload.limitRow' | translate">
            <hrm-upload action="https://example.com/upload" [multiple]="true" accept=".pdf" [maxCount]="3">
              <hrm-button variant="default"><tabler-icon [icon]="$any(paperclip)" [size]="16" />{{ 'docs.upload.uploadPdf' | translate }}</hrm-button>
            </hrm-upload>
          </sg-row>
        </sg-example>
      </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SgDocUpload, { className: "SgDocUpload", filePath: "apps/ds-demo/src/app/features/styleguide/pages/hrm/data-entry/upload.ts", lineNumber: 86 });
})();
export {
  SgDocUpload
};
//# sourceMappingURL=chunk-HCXK736Y.js.map
